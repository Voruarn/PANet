...
if __name__ == '__main__':
    ...
    model.to(device)
    in_ = torch.ones(2, 3, 512, 512).to(device)
    y = model(in_)
    for t in y:
...
"""
t.shape: torch.Size([2, 32, 128, 128])
t.shape: torch.Size([2, 64, 64, 64])
t.shape: torch.Size([2, 128, 32, 32])
t.shape: torch.Size([2, 256, 16, 16])


t.shape: torch.Size([2, 48, 128, 128])
t.shape: torch.Size([2, 96, 64, 64])
t.shape: torch.Size([2, 192, 32, 32])
t.shape: torch.Size([2, 384, 16, 16])
"""
